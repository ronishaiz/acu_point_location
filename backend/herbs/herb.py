...
class HerbGroup(Enum):
    ...
    HEAT_PURGERS_AND_DAMP_DRYERS = 'HEAT_PURGERS_AND_DAMP_DRYERS'
    DOWNWARD_DRAINERS = 'DOWNWARD_DRAINERS'
    FIRE_DRAINERS = 'FIRE_DRAINERS'
    FIRE_AND_TOXIN_RELEASERS = 'FIRE_AND_TOXIN_RELEASERS'
    BLOOD_COOLERS_AND_EMPTY_HEAT_RELEASERS = 'BLOOD_COOLERS_AND_EMPTY_HEAT_RELEASERS'
    SUMMER_HEAT_RELEASERS = 'SUMMER_HEAT_RELEASERS'
    DAMP_URINATING_DRAINERS = 'DAMP_URINATING_DRAINERS'
    AROMATIC_DAMP_TRANSFORMERS = 'AROMATIC_DAMP_TRANSFORMERS'
    AROMATIC_ORIFICE_OPENING = 'AROMATIC_ORIFICE_OPENING'
    WIND_DAMP_RELEASERS = 'WIND_DAMP_RELEASERS'
    PHLEGM_RELEASERS = 'PHLEGM_RELEASERS'
    COUGH_AND_WHEEZING_STOPERS = 'COUGH_AND_WHEEZING_STOPERS'
    DISPEL_PHLEGM_BY_VOMITING = 'DISPEL_PHLEGM_BY_VOMITING'
    BLOOD_TONIFIERS = 'BLOOD_TONIFIERS'
    QI_TONIFIERS = 'QI_TONIFIERS'
    YIN_TONIFIERS = 'YIN_TONIFIERS'
    YANG_TONIFIERS = 'YANG_TONIFIERS'
    INTERIOR_HEATERS = 'INTERIOR_HEATERS'
    QI_MOVERS = 'QI_MOVERS'
    BLOOD_MOVERS = 'BLOOD_MOVERS'
    BLEEDING_STOPPERS = 'BLEEDING_STOPPERS'
    ABSORBERS = 'ABSORBERS'
    ANCHORING_SPIRIT_CALMERS = 'ANCHORING_SPIRIT_CALMERS'
    TONIFYING_SPIRIT_CALMERS = 'TONIFYING_SPIRIT_CALMERS'
    WIND_AND_TREMOR_RELEASERS = 'WIND_AND_TREMOR_RELEASERS'
    FOOD_STAGNATION_TREATERS = 'FOOD_STAGNATION_TREATERS'
